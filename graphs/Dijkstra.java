// Dijkstra doesn't work in negative weight
// Dijkstra doesn't work in negative cycle
// time complexity = O(V * (pop vertex from pq + no. of edges on each vertex * push into pq))
// tc - O(ElogV)
